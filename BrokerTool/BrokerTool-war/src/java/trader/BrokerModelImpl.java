...
public class BrokerModelImpl implements BrokerModel{
    ...
    private BrokerModelImpl(){
        ...
        shares.add(new CustomerShare("999-45-9034", "SUNW", 200));
        ...
        stocks.add(new Stock("SUNW", 135.0));
        stocks.add(new Stock("CyAs", 34.0));
        stocks.add(new Stock("DUKE", 12.375));
        stocks.add(new Stock("ABStk", 20.875));
        stocks.add(new Stock("JSVCo", 24.00));
        stocks.add(new Stock("TMAs", 80.125));
        stocks.add(new Stock("BWInc", 6.25));
        stocks.add(new Stock("GMEnt", 52.50));
        stocks.add(new Stock("PMLtd", 201.875));
